...
exports.routerEvents = exports.useNavigation = exports.createRouter = void 0;
const react_1 = require("react");
const events_1 = require("./events");
const utils_1 = require("./utils");
const context_1 = require("./context");
const routerEvents = new events_1.RouterEvents();
...
function createRouter(settings) {
    const Router = (0, react_1.memo)(function Router({ children }) {
        ...
        return (0, react_1.createElement)(context_1.RouterProvider, {
            value: {
    ...
    const RouterView = (0, react_1.memo)(function Routes({ children }) {
        const context = (0, react_1.useContext)(context_1.RouterContext);
