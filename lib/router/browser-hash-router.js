...
exports.BrowserHashRouter = void 0;
...
const BrowserHashRouter = ({ children }) => {
    const router = (0, react_1.useMemo)(() => (0, create_router_1.createRouter)({ decodeUrl: (url) => new URL(url.hash.slice(1), 'http://localhost'), window }), []);
    // return <RouterContext.Provider value={router}>{children}</RouterContext.Provider>;
    return (0, react_1.createElement)(router_context_1.RouterContext.Provider, { value: router }, [children]);
};
exports.BrowserHashRouter = BrowserHashRouter;
