...
function useForm({ defaultValues, validation }) {
    const [inputs, setInputs] = (0, react_1.useState)(defaultValues);
    ...
    const [errors, setErrors] = (0, react_1.useState)(errorDefaultValues);
    const [touchedFields, setTouchedFields] = (0, react_1.useState)(defaultTouchedFields);
    const [hasError, setHasError] = (0, react_1.useState)(false);
    const isEmptyObject = (obj) => {
        return !Object.keys(obj).length;
    };
    const dirtyFields = (0, react_1.useMemo)(() => {
