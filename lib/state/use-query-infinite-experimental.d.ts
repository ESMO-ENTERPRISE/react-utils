import { InfiniteDataQueryOptionsType } from "./use-query-infinite";
import { DataQueryKeyType, FetcherType } from "./types";
/**
 ...
 * @returns
 */
export declare const useExperimentalInfiniteQuery: <T = any>(queryKey: DataQueryKeyType, fetcher: FetcherType, containerRef: {
    current: HTMLElement;
}, options: {
...
} & Omit<import("./types").UseDataQueryOptionsType<[] | T[][]>, "autoFetchEnabled" | "refetchOnWindowFocus"> & {
