...
exports.useExperimentalInfiniteQuery = void 0;
const react_1 = require("react");
const use_query_infinite_1 = require("./use-query-infinite");
 ...
 * @returns
 */
const useExperimentalInfiniteQuery = (queryKey, fetcher, containerRef, options) => {
    if (!queryKey) {
    ...
    const { options: { offsetBottom: defaultOffsetBottom }, } = (0, provider_1.useQueryContext)();
    ...
    const operation = (0, react_1.useRef)((0, utils_1.getRaceHelper)());
    const { data, reset, fetchPage, fetchNextPage, hasNextPage, isFetching, isSuccess, isFetchingNextPage, isLoading, } = (0, use_query_infinite_1.useInfiniteQuery)(queryKey, fetcher, {
        ...otherOptions,
        onSuccess: () => {
...
exports.useExperimentalInfiniteQuery = useExperimentalInfiniteQuery;
