...
export type Path<T, P extends string = ''> = AnyPath<T, P> extends never ? ArrayPath<T, P> extends never ? ObjectPath<T, P> extends never ? P : ObjectPath<T, P> : ArrayPath<T, P> : AnyPath<T, P>;
...
export type PathValue<T, P extends string = ''> = ArrayPathValue<T, P> extends never ? ObjectPathValue<T, P> extends never ? any : ObjectPathValue<T, P> : ArrayPathValue<T, P>;
export {};
